...
#model 4: DRB bert
d4 = pd.read_csv(csv3,float_precision='round_trip',header=None)
d4 = d4.iloc[:,2]
...
sns.heatmap( d1, ax=ax1,  vmin= 0., vmax=1.0, cbar=False)
sns.heatmap(df2, ax=ax2,  vmin= 0., vmax=1.0, cbar=False)
sns.heatmap(df3, ax=ax3,  vmin= 0., vmax=1.0, cbar=False)
sns.heatmap(df4, ax=ax4,  vmin= 0., vmax=1.0, cbar=True)
